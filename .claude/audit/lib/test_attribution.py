...
adj3_short, _ = decay({"금리": {"조정치": 3, "최초부여일": "2026-01-01",
                        "마지막감쇄일": None}}, "금리", 3, "2026-03-01")
check("양수 90일 미만 유지", adj3_short, 3)
adj3_long, _ = decay({"금리": {"조정치": 3, "최초부여일": "2026-01-01",
                       "마지막감쇄일": None}}, "금리", 3, "2026-04-15")
check("양수 90일 이상 감쇄", adj3_long, 2)
...
decay(RE, "금리", 1, "2026-04-01")             # 음수 해제 (양수 전환)
check("양수로 풀리면 새 최초부여일 기록", RE["금리"]["최초부여일"], "2026-04-01")
