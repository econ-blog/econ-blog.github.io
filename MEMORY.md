...
| 08-06 중 | 사람이 `승인 #P0804` 전송 |
| 08-07 01:30 | **러너 대기 15분 끝에 취소** — 폴링 회차 통째로 유실 |
| 08-08 01:30 | 인박스 성공(1초). `getUpdates` 0건 — 답장은 24시간을 넘겨 이미 삭제됨. 오프셋 582543245 그대로. 대기 PR 3건 경보 재발송 |
